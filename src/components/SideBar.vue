...
aside {
    ...
    border-bottom: 1px solid var(--primary-background-color-dark-light);
    border-radius: 1rem;
}
...
#side-bar-header {
    ...
    padding-bottom: 1rem;
    align-items: center;
    border-bottom: 0.25rem solid var(--primary-font-color);
...
.side-bar-header-search-bar-autocomplete {
    margin: 0 1rem;
    width: 90% !important;
}
